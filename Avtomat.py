...
def all_csv(birga_1, birga_2, rate1, rate2, val1, val2, val4, val1_vol, val2_vol, val4_vol, reponse_b1, reponse_b2, start11):
    ...
    if reponse_b1 != 'Not Enough Money' and reponse_b2 != 'Not Enough Money':
        ...
        pass
    return
def order(regims, birga_1, birga_2, val1_vol, val1, rate1, val2_vol, val2, val3_vol, val3, rate2, val4_vol, val4, valuta, start11):
...
def avtomat(dft, valuta, start11):
    ...
    if USD_fil.shape[0]>0:
        for ind in USD_fil.index:
            ...
            order(regims, birga_1, birga_2, val1_vol, val1, rate1, val2_vol, val2, val3_vol, val3, rate2, val4_vol, val4, valuta, start11)
            break
        return
